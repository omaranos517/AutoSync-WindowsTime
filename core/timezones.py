...
for country, capital, _iana_timezone, preferred_windows_id in COUNTRY_TIMEZONES:
...
def find_timezone_matches(query):
    ...
    matches = []
    for country, capital, iana_timezone, preferred_windows_id in COUNTRY_TIMEZONES:
        searchable = " ".join((country, capital, iana_timezone, preferred_windows_id)).lower()
            ...
            matches.append(
                {
                    ...
                    "iana_timezone": iana_timezone,
                    "preferred_windows_id": preferred_windows_id,
                    "label": _timezone_label(country, capital, iana_timezone, online_info.get("utc_offset")),
                }
            )
